...
# ---------------------------------------------------------------- settings
# This Mega is a CH340 clone, so it enumerates as /dev/ttyUSB*, NOT ttyACM*.
# 99-ars-robot.rules pins it to /dev/arduino so the number can never shift
# when the lidar is also plugged in.
PORT      = "/dev/arduino"
BAUD      = 115200
